...
export default function ClassStatsPage() {
    ...
    if (loading && !stats) {
        return (
            <div className="min-h-screen bg-white flex items-center justify-center font-black text-4xl uppercase animate-pulse">
                Analyzing Batch...
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-white text-black font-sans box-border selection:bg-[#ffde00]">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative group">
                        <select
                            ...
                            className="appearance-none bg-[#00ffff] text-black border-4 border-black px-4 py-1 pr-10 font-black uppercase text-xl cursor-pointer hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[4px_4px_0_0_#000] active:translate-x-0 active:translate-y-0 active:shadow-none transition-all"
                        >
                            {classes.map(c => (
                                <option key={c} value={c}>{c}</option>
                            ))}
                        </select>
                        <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-black" size={24} />
                    </div>
                </div>
            ...
            <main className="max-w-7xl mx-auto py-12 px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    {/* Academic Weapon */}
                    <div className="col-span-1 md:col-span-2 bg-white border-4 border-black p-8 relative overflow-hidden group shadow-[8px_8px_0_0_#000]">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex-1 bg-[#ffde00] border-4 border-black p-6 shadow-[8px_8px_0_0_#000] rotate-1">
                        ...
                        <div className="flex-1 bg-[#00ffff] border-4 border-black p-6 shadow-[8px_8px_0_0_#000] -rotate-1">
                            <div className="flex items-center gap-2 mb-2 font-black uppercase text-xs">
                        ...
                        <div className="w-full md:w-auto">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full md:w-64 bg-white border-4 border-black p-3 font-black placeholder:text-gray-300 focus:outline-none focus:shadow-[4px_4px_0_0_#000] transition-all"
                                />
