...
export default function Hero4() {
    return (
        <header className="relative py-8 md:py-16 px-4 md:px-6 bg-white text-black flex flex-col items-center text-center border-b-4 border-black w-full max-w-full justify-center min-h-[60svh] md:min-h-[70svh]">
            ...
            <div className="bg-black text-white px-3 py-1 font-mono font-bold text-xs md:text-sm mb-4 rotate-[-3deg] max-w-[90vw] truncate shadow-[2px_2px_0px_0px_#ff69b4] relative z-[1]">
            ...
            {/* Scrolling Marquee — Spans full viewport width to avoid clipping */}
            <div className="w-full relative z-10 mb-12 mt-4">
                <div className="w-screen ml-[calc(50%-50vw)] overflow-hidden py-4">
                    <div className="bg-[#ffde00] border-y-4 border-black py-3 rotate-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex flex-nowrap w-[110%] -ml-[5%] transform scale-105">
                        <div className="whitespace-nowrap animate-marquee font-mono font-black text-base md:text-xl uppercase px-4 min-w-full text-center shrink-0">
                        ...
                        <div className="whitespace-nowrap animate-marquee font-mono font-black text-base md:text-xl uppercase px-4 min-w-full text-center shrink-0" aria-hidden="true">
                            Compare student performance • Track attendance • Dominate the semester • No fluff, just stats •  Compare student performance • Track attendance • Dominate the semester • No fluff, just stats •
                        </div>
                    </div>
                </div>
